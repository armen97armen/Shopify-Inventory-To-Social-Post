...
<body class="min-h-screen bg-black-void dark:bg-black-void light:bg-white font-sans">
    ...
    <!-- Navigation Bar -->
    <?php include_once __DIR__ . '/components/navbar.html'; ?>
        ...
        <div class="max-w-[1200px] mx-auto px-6 py-16">
            ...
            <div class="mb-8 backdrop-blur-lg bg-glass-dark/40 border border-white/20 dark:bg-glass-dark/40 dark:border-white/20 light:bg-white/90 light:border-black/10 rounded-2xl p-8 shadow-2xl fade-in-up">
                ...
                <div id="filterSection">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 mb-4">
                            <input 
                                ...
                                class="flex-1 w-full px-5 py-3.5 bg-chrome-accent dark:bg-chrome-accent light:bg-white border border-white/30 dark:border-white/30 light:border-gray-300 rounded-xl text-white dark:text-white light:text-gray-900 text-sm placeholder-white/50 dark:placeholder-white/50 light:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-neon-blue/60 dark:focus:ring-neon-blue/60 light:focus:ring-blue-500 focus:border-neon-blue/50 dark:focus:border-neon-blue/50 light:focus:border-blue-500 transition-all backdrop-blur-sm min-w-0 shadow-sm light:shadow-sm"
                            >
                            <button 
                                id="applyAIFilterBtn"
                                class="px-8 py-3.5 bg-neon-pink hover:bg-neon-pink/90 dark:bg-neon-pink dark:hover:bg-neon-pink/90 light:bg-pink-600 light:hover:bg-pink-700 text-white font-bold rounded-xl border border-neon-pink/50 dark:border-neon-pink/50 light:border-pink-500 transition-all hover:scale-[1.02] whitespace-nowrap shadow-lg text-sm min-w-[160px]"
                            >
                                Apply AI Settings
                            </button>
                        </div>
                        ...
                        <div class="mt-3">
                            <button 
                                id="exampleSearchBtn"
                                type="button"
                                class="px-3 py-1.5 text-xs bg-glass-dark/40 dark:bg-glass-dark/40 light:bg-gray-50 hover:bg-glass-dark/60 dark:hover:bg-glass-dark/60 light:hover:bg-gray-100 border border-white/20 dark:border-white/20 light:border-gray-200 rounded-lg text-white/80 dark:text-white/80 light:text-gray-700 hover:text-white dark:hover:text-white light:hover:text-gray-900 transition-all hover:scale-[1.02] shadow-sm light:shadow-sm"
                                title="Click to use this example search"
                            >
                                Example: "flower under 50–200 qty between $30–50 in stock"
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center gap-4">
                                    <input 
                                        ...
                                        placeholder="Min" 
                                        min="0" 
                                        class="flex-1 min-w-0 px-4 py-3 bg-chrome-accent dark:bg-chrome-accent light:bg-white border border-white/30 dark:border-white/30 light:border-gray-300 rounded-lg text-white dark:text-white light:text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-neon-blue/60 dark:focus:ring-neon-blue/60 light:focus:ring-blue-500 focus:border-neon-blue/50 dark:focus:border-neon-blue/50 light:focus:border-blue-500 transition-all shadow-sm light:shadow-sm"
                                    >
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <select 
                                    id="statusFilter" 
                                    class="w-full px-4 py-3 bg-chrome-accent dark:bg-chrome-accent light:bg-white border border-white/30 dark:border-white/30 light:border-gray-300 rounded-lg text-white dark:text-white light:text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-neon-blue/60 dark:focus:ring-neon-blue/60 light:focus:ring-blue-500 focus:border-neon-blue/50 dark:focus:border-neon-blue/50 light:focus:border-blue-500 transition-all cursor-pointer shadow-sm light:shadow-sm"
                                >
                    ...
                    <div class="flex flex-wrap items-center gap-4 pt-4 border-t border-white/10 dark:border-white/10 light:border-black/10">
                        <button 
                            id="applyFiltersBtn" 
                            class="px-8 py-3.5 bg-neon-blue hover:bg-neon-blue/90 dark:bg-neon-blue dark:hover:bg-neon-blue/90 light:bg-blue-600 light:hover:bg-blue-700 text-white font-bold rounded-xl border border-neon-blue/50 dark:border-neon-blue/50 light:border-blue-500 transition-all hover:scale-[1.02] shadow-lg text-sm"
                        >
                            Apply Filters
                        </button>
                        <button 
            ...
            <div id="loadingState" class="hidden backdrop-blur-lg bg-glass-dark/40 dark:bg-glass-dark/40 light:bg-white/90 border border-white/20 dark:border-white/20 light:border-gray-200 rounded-2xl p-8 shadow-2xl">
                <div class="flex items-center justify-center gap-4">
                    <div class="w-8 h-8 border-4 border-neon-blue/20 dark:border-neon-blue/20 light:border-blue-300 border-t-neon-blue dark:border-t-neon-blue light:border-t-blue-600 rounded-full animate-spin"></div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#applyAIFilterBtn', function() {
            ...
            // Example search button click handler
            $('#exampleSearchBtn').on('click', function() {
                const exampleQuery = 'flower under 50–200 qty between $30–50 in stock';
                $('#aiFilterInput').val(exampleQuery);
                $('#applyAIFilterBtn').click();
            });
            ...
            function correctInput(input, callback) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        // On error, use original input
                        console.error('Input corrector error:', error);
                        callback(input);
                    }
                });
            }
            ...
            function displayInventory(inventoryData, summary, endpoint = 'inventory') {
                ...
                setTimeout(function() {
                    ...
                    if (inventoryContainer) {
                        inventoryContainer.scrollIntoView({ behavior: 'smooth', block: 'start' });
                    }
                }, 100);
            }
